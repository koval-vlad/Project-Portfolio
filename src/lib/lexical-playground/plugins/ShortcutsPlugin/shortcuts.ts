...
function isModifierMatch(event: KeyboardEvent, mask: ModifierMask): boolean {
  return (
    (mask.altKey === undefined || event.altKey === mask.altKey) &&
    (mask.ctrlKey === undefined || event.ctrlKey === mask.ctrlKey) &&
    (mask.metaKey === undefined || event.metaKey === mask.metaKey) &&
    (mask.shiftKey === undefined || event.shiftKey === mask.shiftKey)
  );
}
