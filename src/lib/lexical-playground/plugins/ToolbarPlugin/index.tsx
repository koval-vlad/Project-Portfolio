...
import {
  getCodeLanguageOptionsShiki,
  getCodeThemeOptionsShiki,
  normalizeCodeLanguageShiki,
} from '../code-shiki-stub';
  ...
  return (
    <DropDown
      ...
      <DropDownItem
        ...
        className={'item wide ' + dropDownActiveClass(value === 'left')}>
        <div className="icon-text-container">
      ...
      <DropDownItem
        ...
        className={'item wide ' + dropDownActiveClass(value === 'center')}>
        <div className="icon-text-container">
      ...
      <DropDownItem
        ...
        className={'item wide ' + dropDownActiveClass(value === 'right')}>
        <div className="icon-text-container">
      ...
      <DropDownItem
        ...
        className={'item wide ' + dropDownActiveClass(value === 'justify')}>
        <div className="icon-text-container">
      ...
      <DropDownItem
        ...
        className={'item wide ' + dropDownActiveClass(value === 'start')}>
        <div className="icon-text-container">
          <i
            className={`icon ${
              isRTL
      ...
      <DropDownItem
        ...
        className={'item wide ' + dropDownActiveClass(value === 'end')}>
        <div className="icon-text-container">
          <i
            className={`icon ${
              isRTL
  ...
  const insertLink = useCallback(() => {
    if (!toolbarState.isLink) {
      ...
      if (!$isRangeSelection(selection) || selection.isCollapsed()) {
        window.alert('Please select text to link first.');
        return;
      }
          ...
          {SUPPORT_SPEECH_RECOGNITION && (
            <button
              ...
              onClick={() => {
                ...
                activeEditor.dispatchCommand(SPEECH_TO_TEXT_COMMAND, !isSpeechToText);
                setIsSpeechToText(!isSpeechToText);
              }}
              className={
                'toolbar-item spaced speech-to-text ' +
                (isSpeechToText ? 'speech-to-text-active' : '')
              }
              title="Speech to text"
              type="button"
              aria-label={isSpeechToText ? 'Stop speech to text' : 'Start speech to text'}>
